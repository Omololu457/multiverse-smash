...
export const REKKA = [
  ...
  { key: "naoya",             driver: "updateNaoyaCommandCombat",           opener: "directional",   retap: "heavy→light (timed)", stages: 3, finisher: "launcher", requireHit: null, srcRequireHit: false, status: "exception", note: "Stage G: PLANNED ROUTE — committed timing-window rekka (Fwd+Heavy → H → L); a LATE or WRONG follow-up self-freezes Naoya 1s (no standard cancel-on-hit rekkaContinue chain)" },
