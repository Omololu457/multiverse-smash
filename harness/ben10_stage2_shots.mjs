...
const OUT = path.join(ROOT, "harness", "ben10_stage2_out");
...
const FORMS = [
  { key: "human", label: "Ben (human)", poses: ["light","heavy","up","air","down_air","benJab1","benJab2"] },
  { key: "xlr8", label: "XLR8", poses: ["light","heavy","up","air","down_air","xlCombo1","xlCombo2","xlCombo3"] },
  { key: "diamondhead", label: "Diamondhead", poses: ["light","heavy","up","air","down_air","dhSwing1","dhSwing2"] },
];
...
console.log(`\n  wrote ${rows.length} crops + 3 montages → harness/ben10_stage2_out/`);
