...
const OUT = path.join(ROOT, "harness", "ben10_stage3_out");
...
const FORMS = [
  { key: "human", label: "Ben (human)", poses: ["benHover"] },
  { key: "xlr8", label: "XLR8", poses: ["xlDash","xlRush"] },
  { key: "diamondhead", label: "Diamondhead", poses: ["dhShoot","dhRising"] },
];
...
console.log(`\n  wrote ${rows.length} crops + 3 montages → harness/ben10_stage3_out/`);
