// harness/companion_crew_group1.mjs — GROUP 1 (Billy's crew) affiliation skins register + apply cleanly
...
const CHARS = ["sasuke", "itachi", "chrollo", "killua"];
await page.goto(`${base}/index.html?harness=1&p1=sasuke&p2=rengoku`, { waitUntil: "load" });
...
for (const ch of CHARS) {
  ...
  check(`${ch}_crew skin registered (name shows Billy's Crew)`, !!crew && /Billy's Crew/.test(crew.name), crew ? crew.name : "MISSING");
