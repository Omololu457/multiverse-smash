// harness/companion_crew_group1.mjs — GROUP 2 (Debbie's crew) affiliation skins register + apply cleanly
...
const CHARS = ["beerus", "netero", "maki", "omniman"];
...
for (const ch of CHARS) {
  ...
  check(`${ch}_crew skin registered (name shows Debbie's Crew)`, !!crew && /Debbie's Crew/.test(crew.name), crew ? crew.name : "MISSING");
