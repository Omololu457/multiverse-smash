// harness/companion_crew_group1.mjs — GROUP 3 (Roman's crew) affiliation skins register + apply cleanly
...
const CHARS = ["rick", "tobirama", "gojo", "hisoka"];
await page.goto(`${base}/index.html?harness=1&p1=rick&p2=rengoku`, { waitUntil: "load" });
...
for (const ch of CHARS) {
  ...
  check(`${ch}_crew skin registered (name shows Roman's Crew)`, !!crew && /Roman's Crew/.test(crew.name), crew ? crew.name : "MISSING");
