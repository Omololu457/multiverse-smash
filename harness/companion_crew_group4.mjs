// harness/companion_crew_group1.mjs — GROUP 4 (Jill's crew) affiliation skins register + apply cleanly
...
const CHARS = ["sukuna", "goku_black", "gold_samurai_ranger", "vegeta"];
await page.goto(`${base}/index.html?harness=1&p1=sukuna&p2=rengoku`, { waitUntil: "load" });
...
for (const ch of CHARS) {
  ...
  check(`${ch}_crew skin registered (name shows Jill's Crew)`, !!crew && /Jill's Crew/.test(crew.name), crew ? crew.name : "MISSING");
