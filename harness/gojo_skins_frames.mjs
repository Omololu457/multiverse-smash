...
const OUT = path.join(ROOT, "harness", "shots", "gojo_frames"); fs.mkdirSync(OUT, { recursive: true });
...
const SKINS=["gojoGradientLimitless","gojoHarlequinSorcerer","gojoCircuitBarrier","gojoChevronStrike"];
const POSES=[["idle",4],["walk",6],["walk",5],["run",6],["light",4],["up",5]];
let ch=0;
for (const id of SKINS){
  await pg.goto(`${base}/index.html?harness=1&p1=gojo`,{waitUntil:"load"});
