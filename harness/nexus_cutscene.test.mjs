...
try {
  ...
  while (guard++ < 520) {   // Prologue + Act 1 + Act 2 + Act 3 + Epilogue = 129 beats + 17 fights
    const g = await gs()
  ...
  ck("all real fights triggered + returned (Act 1: 2, Act 2: 7, Act 3: 8)", seen.fights===17, `fights=${seen.fights}`)
