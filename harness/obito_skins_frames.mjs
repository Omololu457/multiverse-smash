...
const OUT = path.join(ROOT, "harness", "shots", "obito_frames"); fs.mkdirSync(OUT, { recursive: true });
...
const SKINS=["obitoStripeProtocol","obitoHarlequinMask","obitoCircuitEye","obitoMarbledPhantom"];
const POSES=[["idle",4],["walk",6],["walk",5],["run",6],["light",4],["up",5]];
let ch=0;
for (const id of SKINS){
  await pg.goto(`${base}/index.html?harness=1&p1=obito`,{waitUntil:"load"});
