// harness/reanim_shots_newly.mjs — evidence for the reanim gap RE-AUDIT (chars added since the last
// backfill): rengoku, shinobu, ben10, samurai_red_ranger, superman, chrollo. Each had ZERO __reanim
// coverage. Summons each via Tobirama's Edo Tensei, asserts the live vessel renders __reanim sheets,
...
for (const vessel of ["rengoku", "shinobu", "ben10", "samurai_red_ranger", "superman", "chrollo"]) {
