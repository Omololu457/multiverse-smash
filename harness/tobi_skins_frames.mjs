...
const OUT = path.join(ROOT, "harness", "shots", "tobi_frames"); fs.mkdirSync(OUT, { recursive: true });
...
const SKINS=["tobiGradientShade","tobiChevronStrike","tobiShatteredVeil","tobiScaleMail"];
