...
// Approved Stage-2 values per character: [startup, active, recovery], enemyVy, selfVy, archetype label.
// Only characters whose Up-Attack has been IMPLEMENTED (Stage 3) appear here.
const EXPECTED = {
  dragon_ball: {
    goku:       { sar: [6, 4, 8], e: -12, s: -9, arch: "Balanced" },
    vegeta:     { sar: [6, 4, 8], e: -12, s: -9, arch: "Balanced" },
    goku_black: { sar: [6, 4, 8], e: -12, s: -9, arch: "Balanced" },
    frieza:     { sar: [6, 4, 8], e: -12, s: -9, arch: "Balanced" },
    piccolo:    { sar: [6, 4, 8], e: -12, s: -9, arch: "Balanced" },
    cell:       { sar: [5, 4, 9], e: -13, s: -9, arch: "Heavy"    },
    beerus:     { sar: [4, 3, 6], e: -11, s: -8, arch: "Fast/GC"  },
  },
  dc: {
    batman:   { sar: [6, 4, 8],  e: -12, s: -9, arch: "Balanced"       },
    flash:    { sar: [4, 3, 5],  e: -11, s: -8, arch: "Fast/GC (fastest)" },
    superman: { sar: [5, 4, 10], e: -14, s: -9, arch: "Heavy-tank"     },
  },
  demon_slayer: {
    rengoku: { sar: [6, 4, 8], e: -12, s: -9, arch: "Balanced" },
    shinobu: { sar: [4, 3, 6], e: -11, s: -8, arch: "Fast/GC"  },
    zenitsu: { sar: [4, 3, 6], e: -11, s: -8, arch: "Fast/GC"  },
  },
  horror: {
    ghostface: { sar: [4, 3, 6], e: -11, s: -8, arch: "Fast/GC" },
  },
  hunter_x_hunter: {
    chrollo: { sar: [6, 4, 8], e: -12, s: -9, arch: "Balanced" },
    gon:     { sar: [6, 4, 8], e: -12, s: -9, arch: "Balanced (base; ⚑giant adult form)" },
    hisoka:  { sar: [6, 4, 8], e: -12, s: -9, arch: "Balanced" },
    killua:  { sar: [4, 3, 6], e: -11, s: -8, arch: "Fast/GC"  },
    netero:  { sar: [4, 3, 6], e: -11, s: -8, arch: "Fast/GC"  },
  },
};
