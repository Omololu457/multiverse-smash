...
try {
  ...
  await page.keyboard.down("s"); check("guard", (await waitSheet("zenitsu_guard_uniform")).spriteSheet.includes("zenitsu_guard_uniform"), ""); await page.keyboard.up("s"); await waitFrames(3);
  ...
  section("Thunderclap Flurry chain (Down+Heavy) + interrupt");
