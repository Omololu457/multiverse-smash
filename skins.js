...
export const SKINS = {
  ...
  // Spider-Man (SSF2) — NEW standalone build. Required `default` entry so getSkins() returns his real
  // spriteScale (else the 1.0 fallback halves him). No recolor skins — staged.
  spiderman_ssf2: [
  ...
  // Spider-Man (Cosmic Invasion) — NEW standalone build. Required `default` entry (real spriteScale, not 1.0 fallback).
  spiderman_mci: [
