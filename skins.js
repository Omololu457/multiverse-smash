...
export const SKINS = {
  ...
  // GHOSTFACE .EXE — 5 killer-identity skins ("the person behind the mask"). ★SCOPE: only BILLY (default) is
  // fully built (real weak base kit + Sasuke/Deathstroke identity-swaps, Stages 2-3). Stu/Roman/Mrs.Loomis/
  // Amber are SELECTABLE but INCOMPLETE — recolor ONLY (HSV colorize via tools/gen_ghostface_exe_skins.py:
  // Stu=green #3fae5a · Roman=purple #7b4fd0 · Loomis=crimson #c0392b · Amber=hot-pink #e84a9c). Each of those
  // 4 still needs its OWN base-kit + swap-in pair (a separate future task, Ben-10-alien style) — DO NOT ship as
  ...
  ghostface_exe: [
    ...
    { id: "ghostfaceExeAmber",  name: "Amber Freeman (WIP)", unlockLevel: 0, portrait: "./ghostface_exe_idle_uniform__amber.png",  spriteScale: characters.ghostface_exe?.spriteScale, animationData: recolorSkinAnim("ghostface_exe", "amber"),  recolorTag: "amber" }
  ],
  // Ghostface (Billy variant) — standalone playable whose BASE sheets are ghostface's `__billy` recolor
  // (ghostface_*__billy.png). Cosmetic batch skins recolor those → `__billy__<tag>.png` (double-tag, rickPrime
  // pattern). Renders correctly now that ghostface_billy has a SPRITE_MANIFEST entry (spritesheets.js) — the
  // missing manifest entry previously left Billy (and any skin) as a procedural box. Parent `ghostface` stays
  // EXCLUDED (guarded gameplay-identity skin slot).
  ghostface_billy: [
    { id: "default", name: "Default", unlockLevel: 0, portrait: characters.ghostface_billy?.portrait, spriteScale: characters.ghostface_billy?.spriteScale, animationData: null },
    { id: "ghostface_billyAlbedo",   name: "Albedo",   unlockLevel: 0, portrait: recolorPortrait("ghostface_billy", "albedo"),   spriteScale: characters.ghostface_billy?.spriteScale, animationData: recolorSkinAnim("ghostface_billy", "albedo"),   recolorTag: "albedo" },
    { id: "ghostface_billyValkyrie", name: "Valkyrie", unlockLevel: 0, portrait: recolorPortrait("ghostface_billy", "valkyrie"), spriteScale: characters.ghostface_billy?.spriteScale, animationData: recolorSkinAnim("ghostface_billy", "valkyrie"), recolorTag: "valkyrie" },
    { id: "ghostface_billyAlienX",   name: "Alien X",  unlockLevel: 0, portrait: recolorPortrait("ghostface_billy", "alienx"),   spriteScale: characters.ghostface_billy?.spriteScale, animationData: recolorSkinAnim("ghostface_billy", "alienx"),   recolorTag: "alienx" }
  ],
  // Spider-Man (Sam Raimi) — NEW standalone build. Just the required `default` entry (so getSkins() returns
  // his real spriteScale instead of the 1.0 fallback that would halve him). No recolor skins yet — staged.
  // Stage 23 auto-palettes on the 3 recent Spider-Man variants: default art + a render-time colour wash
  // (skinTint/tintStrength, animationData:null — no baked art), the same mechanism as gon/omniman/etc.
  // Brings each up to the roster-wide ≥3-palettes floor. Themes: Noir (dark) + Iron Spider (gold).
  spiderman_raimi: [
    { id: "default", name: "Default", unlockLevel: 0, portrait: characters.spiderman_raimi?.portrait, spriteScale: characters.spiderman_raimi?.spriteScale, animationData: null },
    { id: "spiderman_raimi_noir", name: "Noir",        unlockLevel: 2, portrait: characters.spiderman_raimi?.portrait, spriteScale: characters.spiderman_raimi?.spriteScale, animationData: null, skinTint: "#3a3a46", tintStrength: 0.5 },
    { id: "spiderman_raimi_iron", name: "Iron Spider", unlockLevel: 4, portrait: characters.spiderman_raimi?.portrait, spriteScale: characters.spiderman_raimi?.spriteScale, animationData: null, skinTint: "#d9a441", tintStrength: 0.4 }
  ],
  spiderman_ssf2: [
    { id: "default", name: "Default", unlockLevel: 0, portrait: characters.spiderman_ssf2?.portrait, spriteScale: characters.spiderman_ssf2?.spriteScale, animationData: null },
    { id: "spiderman_ssf2_noir", name: "Noir",        unlockLevel: 2, portrait: characters.spiderman_ssf2?.portrait, spriteScale: characters.spiderman_ssf2?.spriteScale, animationData: null, skinTint: "#3a3a46", tintStrength: 0.5 },
    { id: "spiderman_ssf2_iron", name: "Iron Spider", unlockLevel: 4, portrait: characters.spiderman_ssf2?.portrait, spriteScale: characters.spiderman_ssf2?.spriteScale, animationData: null, skinTint: "#d9a441", tintStrength: 0.4 }
  ],
  spiderman_mci: [
    { id: "default", name: "Default", unlockLevel: 0, portrait: characters.spiderman_mci?.portrait, spriteScale: characters.spiderman_mci?.spriteScale, animationData: null },
    { id: "spiderman_mci_noir", name: "Noir",        unlockLevel: 2, portrait: characters.spiderman_mci?.portrait, spriteScale: characters.spiderman_mci?.spriteScale, animationData: null, skinTint: "#3a3a46", tintStrength: 0.5 },
    { id: "spiderman_mci_iron", name: "Iron Spider", unlockLevel: 4, portrait: characters.spiderman_mci?.portrait, spriteScale: characters.spiderman_mci?.spriteScale, animationData: null, skinTint: "#d9a441", tintStrength: 0.4 }
  ],
