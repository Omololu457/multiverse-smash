...
# ── FINAL animation map (tight gap-separated bands + honest frame picks). MINIMAL-but-real:
#    movement + core normals only. NO specials / ultimate yet (staged, like ghostface_exe). ──
FINAL_JOBS = [
