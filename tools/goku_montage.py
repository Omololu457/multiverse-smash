#!/usr/bin/env python3
# Render Goku (Extreme Butoden) Stage-0 boxes onto labeled grey contact sheets.
# The four EB Goku sheets are teal-keyed (0,128,128) with green (0,255,80) grid/label
# lines. Keys BOTH to grey, labels connected components, tiles them with index+size.
# Usage:
#   python3 tools/goku_montage.py base            -> all boxes, base sheet
#   python3 tools/goku_montage.py ssj 0-40        -> boxes 0..40 of the SSJ sheet
#   python3 tools/goku_montage.py ssg out.png 5,6 -> named output
# Sheet aliases: base / ssj / ssg / ssb
import sys
import numpy as np
...
outname = f"goku_{alias}_montage.png"
