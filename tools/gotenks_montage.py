#!/usr/bin/env python3
# Render Super Saiyan Gotenks (Extreme Butoden) Stage-0 boxes onto labeled grey contact
# sheets. Single EB sheet, teal-keyed (0,128,128) with green (0,255,80) grid/label lines
# (identical convention to the EB Goku / Teen Gohan sheets). Keys both to grey, labels
# connected components, tiles them with index+size.
# Usage:
#   python3 tools/gotenks_montage.py            -> all boxes
#   python3 tools/gotenks_montage.py 0-40       -> boxes 0..40
#   python3 tools/gotenks_montage.py out.png 5,6 -> named output
import sys
import numpy as np
