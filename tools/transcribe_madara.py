#!/usr/bin/env python3
# Transcribe the 165 madara_voice_*.mp3 clips (Madara Uchiha, Japanese fighting-game voice rip).
...
# madara_raw_transcript.tsv (resumable). Cols: idx, file, dur, lang, langprob, ja_text, en_gloss.
import glob, os, sys
from faster_whisper import WhisperModel

files = sorted(glob.glob("madara_voice_*.mp3"))
OUT = "madara_raw_transcript.tsv"
done = set()
